...
DARWIN = Platform(
    ...
    description="PowerPC",
    arch="ppc",
    assemble_cmd='/mnt/c/sourcecode/decomp/tools/decomp.me/backend/compilers/powerpc-darwin-cross/powerpc-darwin-cross/bin/cc1 -E -lang-asm -quiet -v -D__DYNAMIC__ "$INPUT" -fPIC -o /tmp/cc1.s | /mnt/c/sourcecode/decomp/tools/decomp.me/backend/compilers/powerpc-darwin-cross/powerpc-darwin-cross/bin/as -o "$OUTPUT"',
    objdump_cmd="/mnt/c/sourcecode/decomp/tools/decomp.me/backend/compilers/powerpc-darwin-cross/powerpc-darwin-cross/bin/otool",
    nm_cmd=" ",
    asm_prelude="""# PowerPC Register Constants
.set r0,0
.set r1,1
.set r2,2
.set r3,3
